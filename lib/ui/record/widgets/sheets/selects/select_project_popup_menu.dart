...
class SelectProjectPopupMenu extends StatefulWidget {
  final int? projectId;
  final String? projectName;
  final List<Project> projects;
  final Function(String)? onSelected;

  const SelectProjectPopupMenu({
    super.key,
    this.projectId,
    this.projectName,
  ...
  @override
  State<SelectProjectPopupMenu> createState() => _SelectProjectPopupMenuState();
}

class _SelectProjectPopupMenuState extends State<SelectProjectPopupMenu> {
